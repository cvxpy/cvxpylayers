...
After computing the transport plan, we backpropagate through a single entry `P[i,j]` to find how to change the support points, probabilities, or regularization to increase that coupling.
